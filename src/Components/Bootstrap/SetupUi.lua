...
local gameFrame: Frame = nil
local renderFrame: Frame = nil
local ui: Frame = nil

local camera: Frame = nil
local viewScale: UIScale = nil
...
local function setup()
	if not checkIfAlreadyExists(gameFrame) then
		...
		renderFrame.AnchorPoint = Vector2.new(0.5, 0.5) --> 0.5 0.5
		renderFrame.Position = UDim2.fromScale(0.5, 0.5) --> 0.5 0.5
		...
		-- for Camera.lua scaling
		viewScale = Instance.new("UIScale")
		viewScale.Name = "ViewScale"
		viewScale.Parent = camera
