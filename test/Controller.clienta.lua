...
local Iris = require(script.Parent.Modules["Iris-2.0.2"]).Init()
local Tbl = require(script.Parent.tbl)
...
Rethink.GetModules().Scene.Events.ObjectAdded:Connect(function(object)
	table.insert(sceneObjects, object)
end)

Rethink.GetModules().Scene.Events.ObjectRemoved:Connect(function(object)
